...
import type { RecipeIngredientsExistenceChecker } from '@src/bounded-contexts/recipes/domain/services/recipe-ingredients-existence-checker.service';
  ...
  implements CommandHandler<CreatorRecipeCommand>
{
  constructor(
    ...
    private readonly recipeIngredientsExistenceChecker: RecipeIngredientsExistenceChecker,
